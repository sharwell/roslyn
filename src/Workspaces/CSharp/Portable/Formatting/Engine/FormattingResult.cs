...
namespace Microsoft.CodeAnalysis.CSharp.Formatting
{
    ...
    internal class FormattingResult : AbstractFormattingResult
    {
        ...
        {
            var rewriter = new TriviaRewriter(this.TreeInfo.Root, IntervalTree.Create(new TextSpanIntervalIntrospector(), this.FormattedSpan), changeMap, cancellationToken);
