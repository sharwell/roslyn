...
#End If
        ...
        Protected Overrides Function CreateAggregatedFormattingResult(node As SyntaxNode, results As IList(Of AbstractFormattingResult), Optional formattingSpans As IntervalTree(Of TextSpan, TextSpanIntervalIntrospector) = Nothing) As IFormattingResult
