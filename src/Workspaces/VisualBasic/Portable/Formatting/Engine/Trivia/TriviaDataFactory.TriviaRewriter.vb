...
Namespace Microsoft.CodeAnalysis.VisualBasic.Formatting
    Friend Class TriviaDataFactory
        Friend Class TriviaRewriter
            ...
            Private ReadOnly _spans As IntervalTree(Of TextSpan, TextSpanIntervalIntrospector)
            ...
            Public Sub New(node As SyntaxNode, spanToFormat As IntervalTree(Of TextSpan, TextSpanIntervalIntrospector), map As Dictionary(Of ValueTuple(Of SyntaxToken, SyntaxToken), TriviaData), cancellationToken As CancellationToken)
