...
namespace Microsoft.CodeAnalysis.Formatting
{
    internal abstract class AbstractAggregatedFormattingResult : IFormattingResult
    {
        ...
        private readonly IntervalTree<TextSpan, TextSpanIntervalIntrospector> _formattingSpans;
        ...
        public AbstractAggregatedFormattingResult(
            ...
            IntervalTree<TextSpan, TextSpanIntervalIntrospector> formattingSpans)
        {
        ...
        protected IntervalTree<TextSpan, TextSpanIntervalIntrospector> GetFormattingSpans()
        {
            return _formattingSpans ?? IntervalTree.Create(new TextSpanIntervalIntrospector(), _formattingResults.Select(r => r.FormattedSpan));
        }
