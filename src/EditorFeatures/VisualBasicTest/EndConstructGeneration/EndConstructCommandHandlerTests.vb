...
Namespace Microsoft.CodeAnalysis.Editor.VisualBasic.UnitTests.EndConstructGeneration
    ...
    Public Class EndConstructCommandHandlerTests
        Private ReadOnly _endConstructServiceMock As New Mock(Of IEndConstructGenerationService)
        Private ReadOnly _featureOptions As New Mock(Of IOptionService)(MockBehavior.Strict)
        Private ReadOnly _textViewMock As New Mock(Of ITextView)
        Private ReadOnly _textBufferMock As New Mock(Of ITextBuffer)
