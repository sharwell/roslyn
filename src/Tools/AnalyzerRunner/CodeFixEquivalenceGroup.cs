...
namespace AnalyzerRunner
{
    internal class CodeFixEquivalenceGroup
    {
        ...
        internal static async Task<ImmutableArray<CodeFixEquivalenceGroup>> CreateAsync(CodeFixProvider codeFixProvider, ImmutableDictionary<ProjectId, AnalysisResult> allDiagnostics, Solution solution, CancellationToken cancellationToken)
        {
